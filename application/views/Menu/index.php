        ...
        <?= $this->session->flashdata('message');?>
          ...
          <a href="" class="btn btn-primary btn-sm mb-3" data-toggle="modal" data-target="#newMenuModal">Tambah menu</a>
          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php foreach($menu as $sm): ?>
                      <tr>
                          ...
                          <td><?= $sm['menu'] ?></td>
                          <td>
                              <a href="<?= base_url();?>menu/ubahmenu/<?= $sm['id'] ?>" class="btn btn-success btn-sm">Edit</a>
