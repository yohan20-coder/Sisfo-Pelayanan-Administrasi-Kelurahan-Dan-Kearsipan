...
<div class="container-fluid">
         ...
         <div class="row">
         	<div class="col-lg-12">
         		 <!-- <form action="<?= base_url();?>arsip/edit/<?= $edit['id'] ?>" method="post"> -->

             <?= form_open_multipart('arsip/editproses') ?> 
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="klasi" value="<?= $edit['noklasi'];?>">
                ...
                <div class="form-group row">
                   ...
                   <?= form_error('perihal','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea class="form-control" name="ringkas" rows="4" required><?= $edit['isi'];?></textarea>
					...
					<div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea class="form-control" name="dispos" rows="4" required><?= $edit['disposisi'];?></textarea>
